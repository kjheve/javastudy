...
public class ItemSales {
   ...
   private int sales; // 총 판매금액
   private int discounts; // 총 할인금액
   private int itemCost; // 판매 가격
   private int bulkMin; // 대량 판매 수량
   private int bulkDiscount; // 대량 판매 할인율

   // 생성자
   public ItemSales(int itemCost, int bulkMin, int bulkDiscount) {
